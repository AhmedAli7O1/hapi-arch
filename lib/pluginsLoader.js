    ...
    if (pluginData.folders.indexOf('models') >= 0) {
      ...
      modulesLoader.loadAll(
          ...
          (modulePath, moduleName) => {
            pluginData.models[moduleName] = db.model(moduleName, require(modulePath));
          });
  ...
  try {
    if (pluginData.folders.indexOf('services') >= 0) {
      ...
      modulesLoader.loadAll(
          ...
          (modulePath, moduleName) => {
            pluginData.services[moduleName] = require(modulePath)(server, options, pluginData.models, methods);
          });
  ...
  try {
    if (pluginData.folders.indexOf('controllers') >= 0) {
      ...
      modulesLoader.loadAll(
          ...
          (modulePath, moduleName) => {
            pluginData.controllers[moduleName] = require(modulePath)(server, options, pluginData.services, methods);
          });
    }
  ...
  try { 
    if (pluginData.folders.indexOf('schema') >= 0) {
      ...
      modulesLoader.loadAll(
          ...
          (modulePath, moduleName) => {
            pluginData.schema[moduleName] = require(modulePath);
          });
    }
