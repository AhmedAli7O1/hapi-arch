...
const locations = {
  APP_MIN_DIR: getAppMainDir(),
  USER_CONFIG: getUserConfigPath(),
  APP_CONFIG: getAppConfigPath(),
  ARCH_PLUGINS: archFs.join(getAppMainDir(), config.paths.archPlugins),
  ARCH_SERVICES: archFs.join(getAppMainDir(), config.paths.archServices),
};
