...
describe("fs", function() {
  ...
  describe("#resolvePaths()", () => {
    ...
    it('should resolve all paths with a handler', () => {
      ...
      fsTest.resolvePaths(data, '/home', (resolvedPath) => result.push(resolvedPath));
  ...
  describe('#canRead()', () => {
    ...
    it('should return true for existing directory', async () => {
      await expect(fsTest.canRead(path.resolve(temp))).to.eventually.equal(true);
    });

    it('should return false for non-existing file', async () => {
      await expect(fsTest.canRead(path.resolve(temp, 'test.js'))).to.eventually.equal(false);
    });
